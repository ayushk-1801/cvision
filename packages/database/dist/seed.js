...
model Application {
  ...
  matchScore       Float? // Score from CV analysis
  cvAnalysis       String? // Results from CV analysis

  @@unique([jobId, applicantId]) // Prevent duplicate applications
  @@map("application")
}
`,
      "inlineSchemaHash": "4307590a384efe8837863b89200d05073f328f0f9e96b4fd65ff801011934716",
      "copyEngine": true
    };
    var fs2 = require("fs");
